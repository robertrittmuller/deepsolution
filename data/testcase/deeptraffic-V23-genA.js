...
// CUSTOM_VARS_BEGIN
var gen_name = 'genA-V23';
var count = 0;
var eval = false;
var save_checkpoint = 250;
var noSaveCheckpoint = false;
var eval_start = 200;
var target_mph = 67.00;
// CUSTOM_VARS_END
...
// CUSTOM_CODE_BEGIN
    ...
    if(self.document !== undefined) {
        if ((document.getElementById("trainProgress").value > 0) && (document.getElementById("trainProgress").value < 95)) {
            noSaveCheckpoint = false;
        } else {
            noSaveCheckpoint = true;
        }
    }

    if (typeof(count) != "undefined") {
        if(noSaveCheckpoint == false) {
